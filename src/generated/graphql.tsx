...
export type ShowIssueQuery = (
  { __typename?: 'Query' }
  & { repository: Maybe<(
    { __typename?: 'Repository' }
    & { issue: Maybe<(
      { __typename?: 'Issue' }
      & Pick<Issue, 'title' | 'bodyText' | 'number' | 'publishedAt' | 'updatedAt' | 'closed'>
      & { comments: (
        { __typename?: 'IssueCommentConnection' }
        ...
        & { edges: Maybe<Array<Maybe<(
          ...
          & { node: Maybe<(
            { __typename?: 'IssueComment' }
            & Pick<IssueComment, 'bodyText' | 'publishedAt'>
            & { author: Maybe<(
              { __typename?: 'User' }
  ...
  & { repository: Maybe<(
    ...
    & { issues: (
      ...
      & { pageInfo: (
        ...
        & { node: Maybe<(
          { __typename?: 'Issue' }
          & Pick<Issue, 'title' | 'number' | 'publishedAt' | 'updatedAt' | 'closed'>
        )> }
      )>>> }
    ) }
  )> }
...
export const ShowIssueDocument = gql`
  ...
  repository(owner: "facebook", name: "react") {
    ...
    `;
export type ShowIssueComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<ShowIssueQuery, ShowIssueQueryVariables>, 'query'> & ({ variables: ShowIssueQueryVariables; skip?: boolean; } | { skip: boolean; });

    export const ShowIssueComponent = (props: ShowIssueComponentProps) => (
      <ApolloReactComponents.Query<ShowIssueQuery, ShowIssueQueryVariables> query={ShowIssueDocument} {...props} />
    );
    
export type ShowIssueProps<TChildProps = {}> = ApolloReactHoc.DataProps<ShowIssueQuery, ShowIssueQueryVariables> & TChildProps;
export function withShowIssue<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  ShowIssueQuery,
  ShowIssueQueryVariables,
  ShowIssueProps<TChildProps>>) {
    return ApolloReactHoc.withQuery<TProps, ShowIssueQuery, ShowIssueQueryVariables, ShowIssueProps<TChildProps>>(ShowIssueDocument, {
      alias: 'showIssue',
      ...operationOptions
    });
};
...
/**
 * __useShowIssueQuery__
 *
 * To run a query within a React component, call `useShowIssueQuery` and pass it any options that fit your needs.
 * When your component renders, `useShowIssueQuery` returns an object from Apollo Client that contains loading, error, and data properties 
 ...
 * });
 */
export function useShowIssueQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ShowIssueQuery, ShowIssueQueryVariables>) {
        return ApolloReactHooks.useQuery<ShowIssueQuery, ShowIssueQueryVariables>(ShowIssueDocument, baseOptions);
      }
export function useShowIssueLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ShowIssueQuery, ShowIssueQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<ShowIssueQuery, ShowIssueQueryVariables>(ShowIssueDocument, baseOptions);
        }
export type ShowIssueQueryHookResult = ReturnType<typeof useShowIssueQuery>;
export type ShowIssueLazyQueryHookResult = ReturnType<typeof useShowIssueLazyQuery>;
export type ShowIssueQueryResult = ApolloReactCommon.QueryResult<ShowIssueQuery, ShowIssueQueryVariables>;
export const ListIssuesDocument = gql`
  ...
  repository(owner: "facebook", name: "react") {
    ...
    `;
export type ListIssuesComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<ListIssuesQuery, ListIssuesQueryVariables>, 'query'>;

    export const ListIssuesComponent = (props: ListIssuesComponentProps) => (
      <ApolloReactComponents.Query<ListIssuesQuery, ListIssuesQueryVariables> query={ListIssuesDocument} {...props} />
    );
    
export type ListIssuesProps<TChildProps = {}> = ApolloReactHoc.DataProps<ListIssuesQuery, ListIssuesQueryVariables> & TChildProps;
export function withListIssues<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  ListIssuesQuery,
  ListIssuesQueryVariables,
  ListIssuesProps<TChildProps>>) {
    return ApolloReactHoc.withQuery<TProps, ListIssuesQuery, ListIssuesQueryVariables, ListIssuesProps<TChildProps>>(ListIssuesDocument, {
      alias: 'listIssues',
      ...operationOptions
    });
};
